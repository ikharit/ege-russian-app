...
const trainers: TrainerItem[] = [
  ...
  },
  {
    id: 'task3-swipe',
    taskNumber: '⚡',
    title: 'Задание 3 — Свайп',
    subtitle: 'Быстрая тренировка ударений (карточки)',
    path: '/task3-swipe',
    color: 'bg-yellow-500',
  ...
  },
  {
    id: 'task25-swipe',
    taskNumber: '⚡',
    title: 'Задание 25 — Свайп',
    subtitle: 'Быстрая тренировка лексики (карточки)',
    path: '/task25-swipe',
    color: 'bg-red-500',
  ...
  },
  {
    id: 'task1',
    taskNumber: '№1',
    title: 'Текст (задание 1)',
    subtitle: 'Задания по маленькому тексту',
    path: '/task1-trainer',
    color: 'bg-orange-500',
  ...
  },
  {
    id: 'task3',
    taskNumber: '№3',
    title: 'Ударения (задание 3)',
    subtitle: 'Пропущенные буквы',
    path: '/task3-trainer',
    color: 'bg-yellow-500',
  ...
  },
  {
    ...
    subtitle: 'Эпитет, метафора, олицетворение',
    path: '/task22-trainer',
    color: 'bg-violet-500',
    bgGradient: 'from-violet-50 to-purple-50',
    borderColor: 'border-violet-200',
  ...
  },
  {
    ...
    taskNumber: '№24',
    title: 'Типы речи',
    subtitle: 'Описание, повествование, рассуждение',
    path: '/task24-trainer',
    color: 'bg-purple-500',
  ...
  },
  {
    ...
    taskNumber: '№25',
    title: 'Лексика',
    subtitle: 'Ударения в сложных словах',
    path: '/task25-trainer',
    color: 'bg-red-500',
    bgGradient: 'from-red-50 to-rose-50',
    borderColor: 'border-red-200',
