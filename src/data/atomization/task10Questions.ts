...
export const task10Questions: Question[] = [
  // === ПРЕ- / ПРИ- (словарные) ===
  {
    id: 'q10-atom-1', type: 'single', text: 'Вставьте пропущенные буквы: пр..исполнен (отваги)',
  ...
  {
    id: 'q10-atom-2', type: 'single', text: 'Вставьте пропущенные буквы: пр..мудрый',
  ...
  {
    id: 'q10-atom-3', type: 'single', text: 'Вставьте пропущенные буквы: пр..следование (врага)',
  ...
  {
    id: 'q10-atom-4', type: 'single', text: 'Вставьте пропущенные буквы: пр..мадонна',
  ...
  {
    id: 'q10-atom-5', type: 'single', text: 'Вставьте пропущенные буквы: пр..града',
  ...
  // === ПРЕ- / ПРИ- (проверяемые) ===
  {
    id: 'q10-atom-6', type: 'single', text: 'Вставьте пропущенные буквы: пр..обрёл',
  ...
  {
    id: 'q10-atom-7', type: 'single', text: 'Вставьте пропущенные буквы: пр..открыть',
  ...
  {
    id: 'q10-atom-8', type: 'single', text: 'Вставьте пропущенные буквы: пр..вязанный (к дереву)',
  ...
  {
    id: 'q10-atom-9', type: 'single', text: 'Вставьте пропущенные буквы: пр..клеить (к картону)',
  ...
  {
    id: 'q10-atom-10', type: 'single', text: 'Вставьте пропущенные буквы: пр..смотреться',
  ...
  // === ПРЕД- / ПОД- ===
  {
    id: 'q10-atom-11', type: 'single', text: 'Вставьте пропущенные буквы: пр..дзащита',
  ...
  {
    id: 'q10-atom-12', type: 'single', text: 'Вставьте пропущенные буквы: пр..дъюбилейный',
  ...
  {
    id: 'q10-atom-13', type: 'single', text: 'Вставьте пропущенные буквы: п..дкараулить',
  ...
  {
    id: 'q10-atom-14', type: 'single', text: 'Вставьте пропущенные буквы: п..дножие (горы)',
  ...
  {
    id: 'q10-atom-15', type: 'single', text: 'Вставьте пропущенные буквы: п..дправить',
  ...
  // === ВС- / ВЗ- / ВЪ- ===
  {
    id: 'q10-atom-16', type: 'single', text: 'Вставьте пропущенные буквы: (рожь) в..колосилась',
  ...
  {
    id: 'q10-atom-17', type: 'single', text: 'Вставьте пропущенные буквы: вз..браться (на гору)',
  ...
  {
    id: 'q10-atom-18', type: 'single', text: 'Вставьте пропущенные буквы: в..пыхнуть',
  ...
  {
    id: 'q10-atom-19', type: 'single', text: 'Вставьте пропущенные буквы: в..езд',
  ...
  {
    id: 'q10-atom-20', type: 'single', text: 'Вставьте пропущенные буквы: в..езжать',
  ...
  // === РАС- / РАЗ- / РОС- / РОЗ- ===
  {
    id: 'q10-atom-21', type: 'single', text: 'Вставьте пропущенные буквы: ра..каяние',
  ...
  {
    id: 'q10-atom-22', type: 'single', text: 'Вставьте пропущенные буквы: раз..брать',
  ...
  {
    id: 'q10-atom-23', type: 'single', text: 'Вставьте пропущенные буквы: ро..черк',
  ...
  {
    id: 'q10-atom-24', type: 'single', text: 'Вставьте пропущенные буквы: роз..ск (преступника)',
  ...
  {
    id: 'q10-atom-25', type: 'single', text: 'Вставьте пропущенные буквы: ра..ширяться',
  ...
  // === БЕЗ- / БЕС- ===
  {
    id: 'q10-atom-26', type: 'single', text: 'Вставьте пропущенные буквы: без..скусный',
  ...
  {
    id: 'q10-atom-27', type: 'single', text: 'Вставьте пропущенные буквы: бес..правный',
  ...
  {
    id: 'q10-atom-28', type: 'single', text: 'Вставьте пропущенные буквы: бе..вкусный',
  ...
  {
    id: 'q10-atom-29', type: 'single', text: 'Вставьте пропущенные буквы: бе..конечный',
  ...
  {
    id: 'q10-atom-30', type: 'single', text: 'Вставьте пропущенные буквы: бе..звёздный',
  ...
  // === ИЗ- / ИС- / ИСПО- ===
  {
    id: 'q10-atom-31', type: 'single', text: 'Вставьте пропущенные буквы: изра..ходовать',
  ...
  {
    id: 'q10-atom-32', type: 'single', text: 'Вставьте пропущенные буквы: и..подтишка',
  ...
  {
    id: 'q10-atom-33', type: 'single', text: 'Вставьте пропущенные буквы: и..следовать',
  ...
  {
    id: 'q10-atom-34', type: 'single', text: 'Вставьте пропущенные буквы: и..подлобья',
  ...
  {
    id: 'q10-atom-35', type: 'single', text: 'Вставьте пропущенные буквы: и..мельчить',
  ...
  // === С- / СЫ- / СУБ- ===
  {
    id: 'q10-atom-36', type: 'single', text: 'Вставьте пропущенные буквы: с..знова',
  ...
  {
    id: 'q10-atom-37', type: 'single', text: 'Вставьте пропущенные буквы: с..грать',
  ...
  {
    id: 'q10-atom-38', type: 'single', text: 'Вставьте пропущенные буквы: с..едобный',
  ...
  {
    id: 'q10-atom-39', type: 'single', text: 'Вставьте пропущенные буквы: суб..ективный',
  ...
  {
    id: 'q10-atom-40', type: 'single', text: 'Вставьте пропущенные буквы: с..ёжиться',
  ...
  // === ОБ- / ОБЕЗ- / ОБЕС- / ОБЪ- ===
  {
    id: 'q10-atom-41', type: 'single', text: 'Вставьте пропущенные буквы: обез..яний',
  ...
  {
    id: 'q10-atom-42', type: 'single', text: 'Вставьте пропущенные буквы: об..ективный',
  ...
  {
    id: 'q10-atom-43', type: 'single', text: 'Вставьте пропущенные буквы: об..явить',
  ...
  {
    id: 'q10-atom-44', type: 'single', text: 'Вставьте пропущенные буквы: обе..цветить',
  ...
  {
    id: 'q10-atom-45', type: 'single', text: 'Вставьте пропущенные буквы: об..ятия',
  ...
  // === НЕ- / НИ- / НЕДО- ===
  {
    id: 'q10-atom-46', type: 'single', text: 'Вставьте пропущенные буквы: не..гибаемый',
  ...
  {
    id: 'q10-atom-47', type: 'single', text: 'Вставьте пропущенные буквы: ни..ходить',
  ...
  {
    id: 'q10-atom-48', type: 'single', text: 'Вставьте пропущенные буквы: нед..считаться',
    options: ['недосчитаться', 'недосчитаться'], correctAnswer: ['недосчитаться'],
    explanation: 'НЕДО- — недостаток (недосчитаться, недооценить).', difficulty: 'medium', xpReward: 10, atoms: ['prefix_unchangeable']
  },
  {
    id: 'q10-atom-49', type: 'single', text: 'Вставьте пропущенные буквы: непр..глядный',
  ...
  {
    id: 'q10-atom-50', type: 'single', text: 'Вставьте пропущенные буквы: непр..емлемый',
  ...
  // === ЧЕРЕС- / ЧРЕЗ- ===
  {
    id: 'q10-atom-51', type: 'single', text: 'Вставьте пропущенные буквы: чере..чур',
  ...
  {
    id: 'q10-atom-52', type: 'single', text: 'Вставьте пропущенные буквы: чере..полосица',
  ...
  {
    id: 'q10-atom-53', type: 'single', text: 'Вставьте пропущенные буквы: чре..вычайное',
  ...
  // === ПРА- / ПРО- ===
  {
    id: 'q10-atom-54', type: 'single', text: 'Вставьте пропущенные буквы: пр..дедушка',
  ...
  {
    id: 'q10-atom-55', type: 'single', text: 'Вставьте пропущенные буквы: прот..тип',
  ...
  // === Сложные приставки ===
  {
    id: 'q10-atom-56', type: 'single', text: 'Вставьте пропущенные буквы: сверх..зысканный',
  ...
  {
    id: 'q10-atom-57', type: 'single', text: 'Вставьте пропущенные буквы: трёх..ядерный',
  ...
  {
    id: 'q10-atom-58', type: 'single', text: 'Вставьте пропущенные буквы: двух..язычный',
  ...
  {
    id: 'q10-atom-59', type: 'single', text: 'Вставьте пропущенные буквы: фотооб..ектив',
  ...
  {
    id: 'q10-atom-60', type: 'single', text: 'Вставьте пропущенные буквы: контр..гра',
  ...
  {
    id: 'q10-atom-61', type: 'single', text: 'Вставьте пропущенные буквы: пред..стория',
  ...
  {
    id: 'q10-atom-62', type: 'single', text: 'Вставьте пропущенные буквы: меж..языковой',
  ...
  {
    id: 'q10-atom-63', type: 'single', text: 'Вставьте пропущенные буквы: зас..лонить',
  ...
  {
    id: 'q10-atom-64', type: 'single', text: 'Вставьте пропущенные буквы: во..пламениться',
  ...
  {
    id: 'q10-atom-65', type: 'single', text: 'Вставьте пропущенные буквы: от..граться',
  ...
  {
    id: 'q10-atom-66', type: 'single', text: 'Вставьте пропущенные буквы: на..конец',
  ...
  {
    id: 'q10-atom-67', type: 'single', text: 'Вставьте пропущенные буквы: за..интересованный',
  ...
  {
    id: 'q10-atom-68', type: 'single', text: 'Вставьте пропущенные буквы: до..бела',
  ...
  {
    id: 'q10-atom-69', type: 'single', text: 'Вставьте пропущенные буквы: пр..европейские (интересы)',
  ...
  {
    id: 'q10-atom-70', type: 'single', text: 'Вставьте пропущенные буквы: пр..студия',
    options: ['при студия', 'престудия'], correctAnswer: ['престудия'],
