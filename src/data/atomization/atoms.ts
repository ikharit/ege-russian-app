...
export const atoms: Atom[] = [
  ...
  // Задание №1 — связи между предложениями
  {
    id: 'task1',
    name: 'Задание №1 — Связи между предложениями',
    description: 'Типы связи между предложениями в тексте: причинно-следственная, противопоставительная, пояснительная, перечислительная.',
    taskNumbers: [1],
    difficulty: 'easy'
  },
  // Задание №2 — лексический анализ
  {
    id: 'task2',
    name: 'Задание №2 — Лексический анализ слова',
    description: 'Стилистическая окраска слова, лексикология и фразеология.',
    taskNumbers: [2],
    difficulty: 'easy'
  },
  // Задание №3 — функциональная стилистика
  {
    id: 'task3',
    name: 'Задание №3 — Культура речи',
    description: 'Речевые ошибки, тавтология, плеоназм, лексическая сочетаемость.',
    taskNumbers: [3],
    difficulty: 'easy'
  },
  // Задание №4 — ударения
  {
    id: 'task4',
    name: 'Задание №4 — Ударения',
    description: 'Правильное постановление ударения в сложных и словарных словах.',
    taskNumbers: [4],
    difficulty: 'easy'
  },
  // Задание №5 — паронимы
  {
    ...
    description: 'Различение паронимов и правильное употребление в контексте.',
    taskNumbers: [5],
    difficulty: 'easy'
  },
  ...
  {
    id: 'task6',
    name: 'Задание №6 — Лексическая сочетаемость',
    description: 'Тавтология, плеоназм, нарушение лексической сочетаемости.',
    taskNumbers: [6],
    difficulty: 'easy'
  },
  // Задание №7 — морфологические нормы
  {
    ...
    description: 'Управление, согласование, однородность членов предложения.',
    taskNumbers: [7],
    difficulty: 'medium'
  },
  // Задание №8 — синтаксические нормы
  {
    ...
    description: 'Нарушение связи в группе однородных членов, логические ошибки.',
    taskNumbers: [8],
    difficulty: 'medium'
  },
  // Задание №9 — корни
  {
    id: 'task9',
    name: 'Задание №9 — Правописание корней',
    description: 'Проверяемые, непроверяемые, чередующиеся корни в словах.',
    taskNumbers: [9],
    difficulty: 'medium'
  },
  // Задание №11 — суффиксы
  {
    id: 'task11',
    name: 'Задание №11 — Суффиксы',
    description: 'Правописание суффиксов прилагательных, наречий, глаголов.',
    taskNumbers: [11],
    difficulty: 'medium'
  },
  ...
  {
    id: 'task16',
    name: 'Задание №16 — Знаки препинания',
    description: 'Расстановка запятых в сложных предложениях, придаточных, вводных словах.',
    taskNumbers: [16],
    difficulty: 'medium'
  },
  // Задание №17 — пунктуация (простое предложение)
  {
    id: 'task17',
    name: 'Задание №17 — Знаки препинания в простом предложении',
    description: 'Однородные члены, вводные слова, обращения, приложения.',
    taskNumbers: [17],
    difficulty: 'medium'
  },
  // Задание №19 — прямая речь
  {
    id: 'task19',
    name: 'Задание №19 — Прямая речь',
    description: 'Постановка знаков препинания в прямой речи и цитатах.',
    taskNumbers: [19],
    difficulty: 'medium'
  },
  // Задание №22 — тропы
  {
    id: 'task22',
    name: 'Задание №22 — Изобразительно-выразительные средства',
    description: 'Тропы и фигуры: метафора, сравнение, олицетворение, эпитет.',
    taskNumbers: [22],
    difficulty: 'medium'
  },
  // Задание №23 — понимание текста
  {
    id: 'task23',
    name: 'Задание №23 — Понимание текста',
    description: 'Нахождение информации в тексте, информационно-смысловая переработка.',
    taskNumbers: [23],
    difficulty: 'easy'
  },
  // Задание №24 — типы информации
  {
    id: 'task24',
    name: 'Задание №24 — Типы информации',
    description: 'Основная, дополнительная, фактографическая, оценочная информация в тексте.',
    taskNumbers: [24],
    difficulty: 'easy'
  },
  // Задание №25 — лексический анализ
  {
    id: 'task25',
    name: 'Задание №25 — Лексический анализ',
    description: 'Определение значения слова по контексту, лексикология и фразеология.',
    taskNumbers: [25],
    difficulty: 'easy'
  },
  // Задание №26 — связи в тексте
  {
    id: 'task26',
    name: 'Задание №26 — Логико-смысловые связи',
    description: 'Типы связи между предложениями в тексте: причинно-следственная, противопоставительная, пояснительная.',
    taskNumbers: [26],
    difficulty: 'easy'
  },
  ...
  {
    id: 'task27',
    name: 'Задание №27 — Сочинение-отзыв',
    description: 'Написание сочинения-отзыва по прочитанному тексту (не менее 200 слов).',
    taskNumbers: [27],
    difficulty: 'hard'
  },
  // Дополнительные тематические атомы
  {
    id: 'roots',
    name: 'Корни слов',
    description: 'Проверяемые, непроверяемые, чередующиеся корни в словах.',
  ...
  {
    id: 'text_connections',
    name: 'Типы связи в тексте',
    description: 'Причинно-следственная, противопоставительная, пояснительная, перечислительная связи.',
    taskNumbers: [1, 26],
    difficulty: 'easy'
  },
  {
    id: 'lexicology',
    name: 'Лексикология',
    description: 'Стилистическая окраска слова, разговорная и книжная лексика.',
    taskNumbers: [2, 25],
    difficulty: 'easy'
  },
  {
  ...
  },
  {
    id: 'paronyms',
    name: 'Паронимы',
    description: 'Различение паронимов и их правильное употребление.',
    taskNumbers: [5],
    difficulty: 'medium'
  },
  {
    id: 'pleonasm',
    name: 'Плеоназм и тавтология',
    description: 'Избыточность в речи, лишние слова.',
    taskNumbers: [6],
    difficulty: 'easy'
  },
  {
  ...
  },
  {
    ...
    description: 'Нахождение информации в тексте, ответы на вопросы по прочитанному.',
    taskNumbers: [23],
    difficulty: 'easy'
  },
  {
  ...
  },
  {
    id: 'essay',
    name: 'Сочинение',
    description: 'Написание сочинения-отзыва по прочитанному тексту.',
    taskNumbers: [27],
    difficulty: 'hard'
  }
]
