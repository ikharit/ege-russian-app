    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'q9-8', type: 'single', text: 'Вставьте пропущенные буквы: сп.шите (текст)', options: ['спешите', 'спишите'], correctAnswer: ['спешите'], explanation: 'Корень -пеш- (чередуется с -пиш- в пишу). Проверочное слово: пеший.', difficulty: 'easy', xpReward: 10, atoms: ['roots'] },
      ...
      },
      {
        ...
        questions: [
          ...
          { id: 'q9-20', type: 'single', text: 'Вставьте пропущенные буквы: либер.лизм', options: ['либерализм', 'либераллизм'], correctAnswer: ['либерализм'], explanation: 'Иноязычное слово (лат. liberalis). Непроверяемая гласная а.', difficulty: 'medium', xpReward: 12, atoms: ['foreign_words'] },
          ...
          { id: 'q9-23', type: 'single', text: 'Вставьте пропущенные буквы: укр.щать', options: ['укрощать', 'укращать'], correctAnswer: ['укрощать'], explanation: 'Корень -крощ- (чередуется с -кращ-). Проверочное слово: кроткий.', difficulty: 'medium', xpReward: 12, atoms: ['roots'] },
          { id: 'q9-24', type: 'single', text: 'Вставьте пропущенные буквы: пок.рять (врага)', options: ['покорять', 'покарять'], correctAnswer: ['покорять'], explanation: 'Корень -кор- в покорять.', difficulty: 'medium', xpReward: 12, atoms: ['roots'] },
          ...
          { id: 'q9-30', type: 'single', text: 'Вставьте пропущенные буквы: пол.гаться (на чьё-то мнение)', options: ['полагаться', 'полягаться'], correctAnswer: ['полагаться'], explanation: 'Корень -лаг- (чередуется с -лож-). Проверочное слово: положить.', difficulty: 'medium', xpReward: 12, atoms: ['roots'] },
        ]
      },
      {
    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'q11-3', type: 'single', text: 'Вставьте пропущенные буквы: застр.вать', options: ['застревать', 'застраивать'], correctAnswer: ['застревать'], explanation: 'Суффикс -ева- в глаголе застревать.', difficulty: 'easy', xpReward: 10, atoms: ['suffixes'] },
