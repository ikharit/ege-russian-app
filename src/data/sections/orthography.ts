    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'q9-8', type: 'text', text: 'Впишите пропущенную букву: сп_шите', correctAnswer: ["е"], explanation: 'Корень -пеш- (чередующийся). Чередование: пеш/пиш. Запомните: спешите (с е), пишу (с и).', difficulty: 'easy', xpReward: 10, atoms: ['task9', 'roots'] },
          { id: 'q9-9', type: 'text', text: 'Впишите пропущенную букву: выд_рать (страницу)', correctAnswer: ["и"], explanation: 'Корень -дир- (чередующийся). Чередование: дир/дра/дер. Зависит от суффикса: драть, выдирать, выдеру.', difficulty: 'easy', xpReward: 10, atoms: ['task9', 'root_vowel_alternation', 'root_dir_dra'] },
      ...
      },
      {
        ...
        questions: [
          ...
          { id: 'q9-21', type: 'text', text: 'Впишите пропущенную букву: м_кнуть (хлеб в соль)', correctAnswer: ["а"], explanation: 'Корень -мак- (чередующийся). Чередование: мак/моч (проверьте через: мочить).', difficulty: 'medium', xpReward: 12, atoms: ['task9', 'roots'] },
          ...
          { id: 'q9-23', type: 'text', text: 'Впишите пропущенную букву: укр_щать', correctAnswer: ["о"], explanation: 'Корень -крощ- (чередующийся). Чередование: крощ/кращ (проверьте через: кроткий).', difficulty: 'medium', xpReward: 12, atoms: ['task9', 'roots'] },
