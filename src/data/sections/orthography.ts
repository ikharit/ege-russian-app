    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'q9-9', type: 'text', text: 'Впишите пропущенную букву: выд_рать (страницу)', correctAnswer: ['а'], explanation: 'Корень -дра- (проверяемый). Проверочное слово: драть.', difficulty: 'easy', xpReward: 10, atoms: ['task9', 'root_verifiable', 'root_dra'] },
