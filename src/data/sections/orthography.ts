    ...
    lessons: [
      ...
      },
      {
        ...
        questions: [
          ...
          { id: 'q9-31', type: 'text', text: 'Впишите пропущенную букву: пр_европейский', correctAnswer: ["о"], explanation: 'Приставка прО- (поддержка, приверженность): проевропейский = поддерживающий Европу. Ср.: пророссийский, проамериканский. Не путайте с прА- (древность): праславянский, праиндоевропейский.', difficulty: 'medium', xpReward: 12, atoms: ['task9', 'prefixes'] },
          { id: 'q9-32', type: 'text', text: 'Впишите пропущенную букву: пр_российский', correctAnswer: ["о"], explanation: 'Приставка прО- (поддержка, приверженность): пророссийский = поддерживающий Россию. Ср.: проевропейский, проамериканский. Не путайте с прА- (древность): праславянский.', difficulty: 'medium', xpReward: 12, atoms: ['task9', 'prefixes'] },
          { id: 'q9-33', type: 'text', text: 'Впишите пропущенную букву: пр_славянский', correctAnswer: ["а"], explanation: 'Приставка прА- (древность, первоначальность): праславянский = древний славянский. Ср.: праиндоевропейский, праязык, прачеловек. Не путайте с прО- (поддержка): проевропейский, пророссийский.', difficulty: 'medium', xpReward: 12, atoms: ['task9', 'prefixes'] },
          { id: 'q9-34', type: 'text', text: 'Впишите пропущенную букву: пр_американский', correctAnswer: ["о"], explanation: 'Приставка прО- (поддержка, приверженность): проамериканский = поддерживающий Америку. Ср.: проевропейский, пророссийский. Не путайте с прА- (древность): праславянский.', difficulty: 'medium', xpReward: 12, atoms: ['task9', 'prefixes'] },
          { id: 'q9-35', type: 'text', text: 'Впишите пропущенную букву: пр_индоевропейский', correctAnswer: ["а"], explanation: 'Приставка прА- (древность, первоначальность): праиндоевропейский = древний индоевропейский. Ср.: праславянский, праязык. Не путайте с прО- (поддержка): проевропейский, пророссийский.', difficulty: 'medium', xpReward: 12, atoms: ['task9', 'prefixes'] },
        ]
      },
      {
