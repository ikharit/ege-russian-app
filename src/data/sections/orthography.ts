    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'q9-8', type: 'text', text: 'Впишите пропущенную букву: сп_шите (текст)', correctAnswer: ['и'], explanation: 'Корень -пиш- (проверяемый). Проверочное слово: пишу.', difficulty: 'easy', xpReward: 10, atoms: ['task9', 'root_verifiable', 'root_pish_pis'] },
