    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'q9-9', type: 'text', text: 'Впишите пропущенную букву: выд_рать (страницу)', correctAnswer: ['е'], explanation: 'Корень -дер- (чередуется с -дра-). Проверочное: драть.', difficulty: 'easy', xpReward: 10, atoms: ['task9', 'root_consonant_alternation', 'root_der_dra'] },
