    ...
    lessons: [
      {
        ...
        prerequisites: [],
        questions: [
          { id: 'q15-1', type: 'single', text: 'Как правильно?', options: ['ветреный', 'ветренный'], correctAnswer: ['ветренный'], explanation: 'Прилагательное от существительного с суффиксом -ен- (ветер → ветренный).', difficulty: 'easy', xpReward: 10, atoms: ['task15', 'n_nn_noun_adj'] },
      ...
      },
      {
        ...
        questions: [
          ...
          { id: 'q15-23', type: 'single', text: 'Как правильно?', options: ['ветренный', 'ветреный'], correctAnswer: ['ветреный'], explanation: 'Прилагательное от существительного (ветер → ветренный).', difficulty: 'medium', xpReward: 12, atoms: ['task15', 'n_nn_noun_adj'] },
