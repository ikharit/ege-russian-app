    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'q15-8', type: 'single', text: 'Как правильно?', options: ['крашеный', 'крашенный'], correctAnswer: ['крашенный'], explanation: 'Прилагательное с суффиксом -енн- (крашенный).', difficulty: 'easy', xpReward: 10 },
          ...
          { id: 'q15-13', type: 'single', text: 'Как правильно?', options: ['непривитый', 'непривитный'], correctAnswer: ['непривитый'], explanation: 'Не + причастие: пишется через одно н (привить → привитый).', difficulty: 'easy', xpReward: 10 },
          { id: 'q15-14', type: 'single', text: 'Как правильно?', options: ['невысказанный', 'невысказаный'], correctAnswer: ['невысказанный'], explanation: 'Не + причастие с приставкой: сохраняются две н (высказать → высказанный).', difficulty: 'easy', xpReward: 10 },
      ...
      },
      {
        ...
        questions: [
          ...
          { id: 'q15-18', type: 'single', text: 'Как правильно?', options: ['посаженный', 'посаженый'], correctAnswer: ['посаженный'], explanation: 'Причастие от глагола совершенного вида (посадить → посаженный).', difficulty: 'medium', xpReward: 12 },
          { id: 'q15-19', type: 'single', text: 'Как правильно?', options: ['тканный', 'тканый'], correctAnswer: ['тканный'], explanation: 'Прилагательное с суффиксом -енн- (тканный).', difficulty: 'medium', xpReward: 12 },
          { id: 'q15-20', type: 'single', text: 'Как правильно?', options: ['рубленый', 'рубленный'], correctAnswer: ['рубленный'], explanation: 'Прилагательное с суффиксом -енн- (рубленный).', difficulty: 'medium', xpReward: 12 },
          { id: 'q15-21', type: 'single', text: 'Как правильно?', options: ['крученый', 'крученный'], correctAnswer: ['крученый'], explanation: 'Причастие от глагола несовершенного вида (крутить → крученый).', difficulty: 'medium', xpReward: 12 },
          ...
          { id: 'q15-24', type: 'single', text: 'Как правильно?', options: ['кованый', 'кованный'], correctAnswer: ['кованый'], explanation: 'Причастие от глагола несовершенного вида (ковать → кованый).', difficulty: 'medium', xpReward: 12 },
          ...
          { id: 'q15-27', type: 'single', text: 'Как правильно?', options: ['покрученный', 'покрученый'], correctAnswer: ['покрученный'], explanation: 'Причастие с приставкой от глагола совершенного вида (покрутить → покрученный).', difficulty: 'medium', xpReward: 12 },
          ...
          { id: 'q15-29', type: 'single', text: 'Как правильно?', options: ['непрошенный', 'непрошеный'], correctAnswer: ['непрошенный'], explanation: 'Не + причастие: сохраняются две н (просить → прошенный).', difficulty: 'medium', xpReward: 12 },
          { id: 'q15-30', type: 'single', text: 'Как правильно?', options: ['сплетенный', 'сплетеный'], correctAnswer: ['сплетенный'], explanation: 'Причастие с приставкой от глагола совершенного вида (сплести → сплетенный).', difficulty: 'medium', xpReward: 12 },
        ]
      }
    ]
  }
