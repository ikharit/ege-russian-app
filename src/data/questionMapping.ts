...
const manualMappings: Record<string, Omit<CanonicalMapping, 'questionIds'> & { questionIds: string[] }> = {
  ...
  'word:исказить:task9': {
    ...
    questionIds: ['q9-2', 'qd9-475'],
  },
  'word:ополчение:task9': {
    word: 'ополчение',
    taskNumber: '9',
    ruleId: 'root_verifiable',
    atomIds: ['root_verifiable', 'roots'],
    questionIds: ['q9-3', 'qd9-403'],
  },
  'word:пловец:task9': {
    word: 'пловец',
    taskNumber: '9',
    ruleId: 'alternation_plav_plov',
    atomIds: ['root_plav_plov', 'vowel_alternation'],
    questionIds: ['q9-6', 'qd9-406'],
  },
  'word:дирижер:task9': {
    word: 'дирижер',
    taskNumber: '9',
    ruleId: 'foreign_words',
    atomIds: ['foreign_words'],
    questionIds: ['q9-7', 'qd9-407'],
  },
  'word:мораторий:task9': {
    word: 'мораторий',
    taskNumber: '9',
    ruleId: 'foreign_words',
    atomIds: ['foreign_words'],
    questionIds: ['q9-10', 'qd9-410'],
  },
  'word:метафора:task9': {
    word: 'метафора',
    taskNumber: '9',
    ruleId: 'foreign_words',
    atomIds: ['foreign_words'],
    questionIds: ['q9-11', 'qd9-411'],
  },
  'word:проживать:task9': {
    word: 'проживать',
    taskNumber: '9',
    ruleId: 'root_verifiable',
    atomIds: ['root_verifiable', 'roots'],
    questionIds: ['q9-15', 'qd9-415'],
  },
