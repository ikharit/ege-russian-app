...
export const accentWordsLevel1: AccentWord[] = [
  ...
  makeWord('w8', 'договоренность', 6, 'Ударение на Ё: договорЁнность', 'easy'),
...
export const accentWordsLevel2: AccentWord[] = [
  ...
  makeWord('w40', 'некролог', 4, 'Ударение на О: некрОлог', 'medium'),
]

// Уровень 3 — сложные слова — 20 слов
export const accentWordsLevel3: AccentWord[] = [
  makeWord('w41', 'партера', 4, 'Ударение на Е: партЕр', 'hard'),
  makeWord('w42', 'портфель', 5, 'Ударение на Е: портфЕль', 'hard'),
  makeWord('w43', 'поручни', 1, 'Ударение на О: пОручни', 'hard'),
  makeWord('w44', 'приданое', 4, 'Ударение на А: придАное', 'hard'),
  makeWord('w45', 'призыв', 4, 'Ударение на Ы: призЫв', 'hard'),
  makeWord('w46', 'свекла', 2, 'Ударение на Ё: свЁкла', 'hard'),
  ...
  makeWord('w56', 'кремень', 4, 'Ударение на Е: кремЕнь', 'hard'),
