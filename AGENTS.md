...
Last updated: 2026-06-26 by Agent 2
...
Last updated: 2026-06-28 by Agent 5
- **Deploy cache-bust v5**: `index.html` — обновлён cache-bust query parameter для принудительного обновления PWA. `peaceiris/actions-gh-pages@v4` с `force_orphan: true` для чистого деплоя. Git: `0bc2673`.
