...
- **Course map — BoardPath**: Вертикальная тропинка как в настольной игре. SVG path между нодами: сплошная линия для пройденного, пунктир для заблокированного. Ноды — 52px круги с glow-анимацией для текущего урока, звёзды и score badge для пройденных.
